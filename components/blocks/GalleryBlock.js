...
export default function GalleryBlock(props) {
  ...
  return (
      ...
      >
        ...
        {props.arrows ?
          <>
            <button className={`${styles.swiperButtonPrev} ${styles.swiperButton}`} ref={navigationPrevRef}></button>
            <button className={`${styles.swiperButtonNext} ${styles.swiperButton}`} ref={navigationNextRef}></button>
          </>
          :
          <>
